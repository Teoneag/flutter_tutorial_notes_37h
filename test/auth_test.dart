...
import 'package:notes_t_37h_2/services/auth/auth_user.dart';
...
void main() {
  group('Mock Authentication', () {
    ...
    test(
      'Should be able to initialize in less than 2 s',
      () async {
        await provider.initialize();
        expect(provider.isInitialized, true);
      },
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({
    ...
    const user = AuthUser(isEmailVerified: false, email: 'yomama');
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser = AuthUser(isEmailVerified: true, email: 'yomama');
    _user = newUser;
  }
}
